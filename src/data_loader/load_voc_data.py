...
class VOCDataset(Dataset):
    def __init__(self, split, image_path:str, annotation_path:str, classes:list, num_classes:int):
        self.split = split
        ...
        self.images_info = load_images_and_anns(self.image_path, self.annotation_path, self.label2idx)
